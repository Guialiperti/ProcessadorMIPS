...
-- *****************************************************************************
-- Generated on "11/29/2019 17:41:42"
...
-- constants                                                 
-- signals                                                   
SIGNAL estendeSinal_IN : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL estendeSinal_OUT : STD_LOGIC_VECTOR(31 DOWNTO 0);
...
-- estendeSinal_IN[15]
t_prcs_estendeSinal_IN_15: PROCESS
BEGIN
	estendeSinal_IN(15) <= '0';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_15;
-- estendeSinal_IN[14]
t_prcs_estendeSinal_IN_14: PROCESS
BEGIN
	estendeSinal_IN(14) <= '0';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_14;
-- estendeSinal_IN[13]
t_prcs_estendeSinal_IN_13: PROCESS
BEGIN
	estendeSinal_IN(13) <= '0';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_13;
-- estendeSinal_IN[12]
t_prcs_estendeSinal_IN_12: PROCESS
BEGIN
	estendeSinal_IN(12) <= '0';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_12;
-- estendeSinal_IN[11]
t_prcs_estendeSinal_IN_11: PROCESS
BEGIN
	estendeSinal_IN(11) <= '1';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_11;
-- estendeSinal_IN[10]
t_prcs_estendeSinal_IN_10: PROCESS
BEGIN
	estendeSinal_IN(10) <= '1';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_10;
-- estendeSinal_IN[9]
t_prcs_estendeSinal_IN_9: PROCESS
BEGIN
	estendeSinal_IN(9) <= '1';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_9;
-- estendeSinal_IN[8]
t_prcs_estendeSinal_IN_8: PROCESS
BEGIN
	estendeSinal_IN(8) <= '1';
WAIT;
END PROCESS t_prcs_estendeSinal_IN_8;
-- estendeSinal_IN[7]
